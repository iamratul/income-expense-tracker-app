    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Update Income Category</h5>
            </div>
...
<script>
   async function FillUpUpdateForm(id){
        ...
        showLoader();
        let res=await axios.post("/income-category-by-id",{id:id})
        hideLoader();
    ...
    async function Update() {
        ...
        if (categoryName.length === 0) {
            ...
            showLoader();
            let res = await axios.post("/update-income-category",{name:categoryName,id:updateID})
            hideLoader();
